...
class Override(Base):
    ...
    original_recommendation: Mapped[Recommendation] = mapped_column(SAEnum(Recommendation, values_callable=lambda x: [e.value for e in x], create_constraint=False), nullable=False)
    new_recommendation: Mapped[Recommendation] = mapped_column(SAEnum(Recommendation, values_callable=lambda x: [e.value for e in x], create_constraint=False), nullable=False)
